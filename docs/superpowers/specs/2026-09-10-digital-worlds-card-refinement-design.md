# Digital Worlds Card Refinement

## Approved direction

Refine the dark two-column digital-project gallery without changing its overall visual identity.
...
- Remove year and location from the cards.
- Replace the longer authorship wording with concise, truthful project-context labels.
- Keep one short project description, constrained to a readable measure and two visual lines where the viewport permits.
- Reduce spacing so the information reads as a compact editorial caption rather than a second content block.
